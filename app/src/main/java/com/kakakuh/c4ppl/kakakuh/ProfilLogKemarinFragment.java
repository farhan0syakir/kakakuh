 ...
 */
public class ProfilLogKemarinFragment extends ProfilLogBaseFragment{

    public ProfilLogKemarinFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTextHari.setText("Kemarin");

        mListLog = (ListView) rootView.findViewById(R.id.list_log);

        //TODO query = Kemarin
        logs = new ArrayList<>();
        logs.add(new Log(2, "a01", "a01 mengadakan pertemuan dengan b01", "Belajar Bareng",
        ...
        logs.add(new Log(2, "a01", "a01 mengadakan pertemuan dengan b01", "Belajar Bareng",
                new Date(new Long("1428200000000")),
