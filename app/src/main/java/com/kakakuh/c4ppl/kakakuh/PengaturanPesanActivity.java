...
public class PengaturanPesanActivity extends KakakuhBaseActivity {
    ...
    final private String[] pilihan = {"5 menit","15 menit","30 menit","1 jam"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedOption = preferensi.getPengaturanPesan();
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!selectedOption.equals(preferensi.getPengaturanPesan())) {
                    preferensi.setPengaturanPesan(selectedOption);
                    preferensi.commit();
