...
public class ProfilLogActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        logs.add(new Log(4, "a01", "a01 mengadakan pertemuan dengan b01", "Belajar Bareng",
        ...
        logs.add(new Log(5, "a01", "a01 mengadakan pertemuan dengan b01", "Belajar Bareng",
                new Date(new Long("1428324100000")),
                BitmapFactory.decodeResource(getResources(), R.drawable.ic_emerald_jadwal))); // Sun Apr 11 2015 08:30:00 GMT+0700 (SE Asia Standard Time)
        logs.add(new Log(6, "a01", "a01 mengadakan pertemuan dengan b01", "Belajar Bareng",
                new Date(new Long("1428324100000")),
                BitmapFactory.decodeResource(getResources(), R.drawable.ic_emerald_jadwal))); // Sun Apr 11 2015 08:30:00 GMT+0700 (SE Asia Standard Time)
        logs.add(new Log(7, "a01", "a01 mengadakan pertemuan dengan b01", "Belajar Bareng",
                new Date(new Long("1428324100000")),
                BitmapFactory.decodeResource(getResources(), R.drawable.ic_emerald_jadwal))); // Sun Apr 11 2015 08:30:00 GMT+0700 (SE Asia Standard Time)
        logs.add(new Log(5, "a01", "a01 mengadakan pertemuan dengan b01", "Belajar Bareng",
